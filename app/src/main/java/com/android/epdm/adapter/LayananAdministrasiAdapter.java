...
public class LayananAdministrasiAdapter extends RecyclerView.Adapter<LayananAdministrasiAdapter.ViewHolder> {


    Context context;
    List<LayananAdministrasiModel> layananAdministrasiModelList;

    public LayananAdministrasiAdapter(Context context, List<LayananAdministrasiModel> layananAdministrasiModelList) {
        this.context = context;
        this.layananAdministrasiModelList = layananAdministrasiModelList;
    }

    LayananAdministrasiAdapter.OnItemClickListener listener;

    public interface OnItemClickListener {
        void onItemClick(View view, int position);
    }
    public void setOnItemClickListener(LayananAdministrasiAdapter.OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        LayananAdministrasiModel model = layananAdministrasiModelList.get(position);
    ...
    public int getItemCount() {
        return layananAdministrasiModelList.size();
    }
