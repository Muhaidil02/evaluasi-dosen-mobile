...
public class LayananKeuanganAdapter extends RecyclerView.Adapter<LayananKeuanganAdapter.ViewHolder> {

    Context context;
    List<LayananKeuanganModel> layananKeuanganModelList;

    public LayananKeuanganAdapter(Context context, List<LayananKeuanganModel> layananKeuanganModelList) {
        this.context = context;
        this.layananKeuanganModelList = layananKeuanganModelList;
    }

    LayananKeuanganAdapter.OnItemClickListener listener;

    public interface OnItemClickListener {
        void onItemClick(View view, int position);
    }
    public void setOnItemClickListener(LayananKeuanganAdapter.OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        LayananKeuanganModel model = layananKeuanganModelList.get(position);
    ...
    public int getItemCount() {
        return layananKeuanganModelList.size();
    }
