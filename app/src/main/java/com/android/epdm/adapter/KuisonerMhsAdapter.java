...
public class KuisonerMhsAdapter extends RecyclerView.Adapter<KuisonerMhsAdapter.ViewHolder> {

    Context context;
    List<KuisonerMhsModel>kuisonerMhsModelList;

    public KuisonerMhsAdapter(Context context, List<KuisonerMhsModel> kuisonerMhsModelList) {
        this.context = context;
        this.kuisonerMhsModelList = kuisonerMhsModelList;
    }

    KuisonerMhsAdapter.OnItemClickListener listener;

    public interface OnItemClickListener {
        void onItemClick(View view, int position);
    }
    public void setOnItemClickListener(KuisonerMhsAdapter.OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        KuisonerMhsModel model = kuisonerMhsModelList.get(position);
    ...
    public int getItemCount() {
        return kuisonerMhsModelList.size();
    }
