...
public class DosenPengabdiLayananAdapter extends RecyclerView.Adapter<DosenPengabdiLayananAdapter.ViewHolder> {

    Context context;
    List<DosenPengabdiLayananModel> dosenPengabdiLayananModelList;

    public DosenPengabdiLayananAdapter(Context context, List<DosenPengabdiLayananModel> dosenPengabdiLayananModelList) {
        this.context = context;
        this.dosenPengabdiLayananModelList = dosenPengabdiLayananModelList;
    }

    DosenPengabdiLayananAdapter.OnItemClickListener listener;

    public interface OnItemClickListener {
        void onItemClick(View view, int position);
    }
    public void setOnItemClickListener(DosenPengabdiLayananAdapter.OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        DosenPengabdiLayananModel model = dosenPengabdiLayananModelList.get(position);
    ...
    public int getItemCount() {
        return dosenPengabdiLayananModelList.size();
    }
