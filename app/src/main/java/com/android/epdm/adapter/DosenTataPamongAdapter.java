...
public class DosenTataPamongAdapter extends RecyclerView.Adapter<DosenTataPamongAdapter.ViewHolder> {

    Context context;
    List<DosenTataPamongModel> dosenTataPamongModelList;

    public DosenTataPamongAdapter(Context context, List<DosenTataPamongModel> dosenTataPamongModelList) {
        this.context = context;
        this.dosenTataPamongModelList = dosenTataPamongModelList;
    }

    DosenTataPamongAdapter.OnItemClickListener listener;

    public interface OnItemClickListener {
        void onItemClick(View view, int position);
    }
    public void setOnItemClickListener(DosenTataPamongAdapter.OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        DosenTataPamongModel model = dosenTataPamongModelList.get(position);
    ...
    public int getItemCount() {
        return dosenTataPamongModelList.size();
    }
