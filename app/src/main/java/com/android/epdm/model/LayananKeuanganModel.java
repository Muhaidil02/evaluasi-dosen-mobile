...
public class LayananKeuanganModel implements Serializable {
    ...
    public LayananKeuanganModel() {
    }

    public LayananKeuanganModel(String pertanyaanId, String pertanyaan, String pilihan1, String pilihan2, String pilihan3, String pilihan4, int pilihanTerpilih) {
