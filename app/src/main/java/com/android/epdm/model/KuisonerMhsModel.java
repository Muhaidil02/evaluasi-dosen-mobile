...
public class KuisonerMhsModel implements Serializable {
    ...
    public KuisonerMhsModel() {
    }

    public KuisonerMhsModel(String pertanyaanId, String pertanyaan, String pilihan1, String pilihan2, String pilihan3, String pilihan4, int pilihanTerpilih) {
