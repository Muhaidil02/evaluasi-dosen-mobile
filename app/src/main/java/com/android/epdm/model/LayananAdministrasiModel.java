...
public class LayananAdministrasiModel implements Serializable {
    ...
    public LayananAdministrasiModel() {
    }
    ...
    public LayananAdministrasiModel(String pertanyaanId, String pertanyaan, String pilihan1, String pilihan2, String pilihan3, String pilihan4, int pilihanTerpilih) {
        this.pertanyaanId = pertanyaanId;
        this.pertanyaan = pertanyaan;
        this.pilihan1 = pilihan1;
        this.pilihan2 = pilihan2;
