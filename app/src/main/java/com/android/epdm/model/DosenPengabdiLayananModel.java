...
public class DosenPengabdiLayananModel implements Serializable {
    ...
    public DosenPengabdiLayananModel() {
    }

    public DosenPengabdiLayananModel(String pertanyaanId, String pertanyaan, String pilihan1, String pilihan2, String pilihan3, String pilihan4, int pilihanTerpilih) {
