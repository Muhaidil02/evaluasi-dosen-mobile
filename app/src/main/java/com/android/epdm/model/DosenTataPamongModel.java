...
public class DosenTataPamongModel implements Serializable {
    ...
    public DosenTataPamongModel() {
    }

    public DosenTataPamongModel(String pertanyaanId, String pertanyaan, String pilihan1, String pilihan2, String pilihan3, String pilihan4, int pilihanTerpilih) {
